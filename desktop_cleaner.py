...
def create_subfolder_if_required(folder_path, subfolder_name):
    ...
    for filename in os.listdir(folder_path):
        if os.path.isfile(os.path.join(folder_path, filename)):
            ...
            if file_extension:
                ...
                subfolder_path = create_subfolder_if_required(folder_path, subfolder_name)
...
if __name__ == "__main__":
    ...
    folder_path = '/Users/sabibarudana/Downloads'
